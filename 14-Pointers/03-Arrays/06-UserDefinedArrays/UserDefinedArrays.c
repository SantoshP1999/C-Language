...
int main(void)
{
    ...
    //**** INTEGER ARRAY ******/
    printf("\n\n");
    printf("Enter The Number Elements You Want In The Integer Array : ");
    ...
    //**** FLOAT ARRAY ******/
    printf("\n\n");
    printf("Enter The Number Elements You Want In The 'Float' Array : ");
    ...
    //**** DOUBLE ARRAY ******/
    printf("\n\n");
    printf("Enter The Number Elements You Want In The 'double' Array : ");
    ...
    //**** CHAR ARRAY ******/
    printf("\n\n");
    printf("Enter The Number Elements You Want In The Character Array : ");
    ...
    if (ptr_cArray)
    {
        ...
        printf("\n\n");
        printf("MEMORY OCCUPIEDNBY CHARACTER ARRAY HAS BEEN SUCCESSFULLY FREED !!!\n\n");
    }
    ...
    if (ptr_dArray)
    {
        ...
        printf("\n\n");
        printf("MEMORY OCCUPIEDNBY DOUBLE ARRAY HAS BEEN SUCCESSFULLY FREED !!!\n\n");
    }
    ...
    if (ptr_fArray)
    {
        ...
        printf("\n\n");
        printf("MEMORY OCCUPIEDNBY FLOAT ARRAY HAS BEEN SUCCESSFULLY FREED !!!\n\n");
    }
    ...
    if (ptr_iArray)
    {
        ...
        printf("\n\n");
        printf("MEMORY OCCUPIEDNBY INTEGER ARRAY HAS BEEN SUCCESSFULLY FREED !!!\n\n");
    }
